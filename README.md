...
@ruedap/abccss/0.9.7 darwin-x64 node-v8.10.0
$ abccss --help [COMMAND]
USAGE
  $ abccss COMMAND
...
...
_See code: [src/commands/component.ts](https://github.com/ruedap/abccss/blob/v0.9.7/src/commands/component.ts)_
...
_See code: [src/commands/decoration.ts](https://github.com/ruedap/abccss/blob/v0.9.7/src/commands/decoration.ts)_
...
_See code: [src/commands/new.ts](https://github.com/ruedap/abccss/blob/v0.9.7/src/commands/new.ts)_
<!-- commandsstop -->
